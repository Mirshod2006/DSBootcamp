...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python3 first_constructor.py <filename> <number of predictions>")
        exit(1)
    
    filename = sys.argv[1]
    number = int(sys.argv[2])
    analytic = Analytics(filename,number)
    print(analytic.data)
    print(analytic.counts())
    print(analytic.fractions())
    print(analytic.predict_random())
